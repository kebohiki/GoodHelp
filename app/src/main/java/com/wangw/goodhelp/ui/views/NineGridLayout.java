...
public class NineGridlayout extends ViewGroup {
    ...
    public NineGridlayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        totalWidth = getResources().getDisplayMetrics().widthPixels - ScreenUtils.dp2px(getContext(),110);
    }
    ...
    private void layoutChildrenView(){
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            childrenView.setImageUrl(((TopicInfo.FilesBean) listData.get(i)).getKey());
    ...
    public void setImagesData(List<TopicInfo.FilesBean> lists) {
